...
static Vertex vertices[] = {
    {(float)0/960-1, (float)-500/540+1, 0.0f, 0.1f, 0.3f, 0.5f, 1.0f},     // top vertex
    {(float)250/960-1, (float)-225/540+1, 0.0f, 0.1f, 0.3f, 0.5f, 1.0f},   // bottom left vertex
    {(float)500/960-1, (float)-125/540+1, 0.0f, 0.1f, 0.3f, 0.5f, 1.0f}     // bottom right vertex
};

// DECLARING INTERFACE, GRAPHICS DEVICE, BUFFERS, PIPELINE
...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char **argv)
{
    ...
    // VERTEX BUFFERS AND ATTRIBUTES ONTO THE PIPELINE
